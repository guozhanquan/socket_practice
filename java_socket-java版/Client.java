...
public class Client{  
    ...
    public void send() {  
        ...
        sendMessage(frame.getTitle() + "@" + userList.getSelectedValue().toString() + "@" + message);  
    ...
    public Client() {  
        ...
        userList.setSelectedIndex(0);// 设置默认显示
        userList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);// 只能选中一行
  ///////////////////////////////////////////////////////
        ...
        btn_start.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                ...
                try {  
                    ...
                    frame.setTitle(name);  
                    JOptionPane.showMessageDialog(frame, name+"成功连接!");  
                } catch (Exception exc) {  
